...
import { ActionAuthLogin, ActionAuthLogout, ActionAuthSuccess } from './auth.actions';
...
describe('AuthReducer', () => {
  ...
  // TODO-Tom: change me to limit on success not just on a login attempt
  it('should set authentication to true on login', () => {
    const action = new ActionAuthSuccess({token: 'mockToken'});
