...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<dtapp-big-input-action></dtapp-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<dtapp-big-input-action [disabled]="true"></dtapp-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<dtapp-big-input-action fontSet="fas" fontIcon="fa-trash"></dtapp-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<dtapp-big-input-action label="delete"></dtapp-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<dtapp-big-input-action (action)="actionHandler()"></dtapp-big-input-action>`;
    fixture = createHostComponent(template);
